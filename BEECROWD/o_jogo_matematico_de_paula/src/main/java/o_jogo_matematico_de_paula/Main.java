...
package o_jogo_matematico_de_paula;
...
public class Main {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < c; i++){
            ...
            n1 = Integer.parseInt(String.valueOf(s1[0]));
            n2 = Integer.parseInt(String.valueOf(s1[2]));

            if (n1 == n2) {
                System.out.println(n1 * n2);
            } else if (Character.isUpperCase(s1[1])) {
                System.out.println(n2 - n1);
            } else if (Character.isLowerCase(s1[1])) {
                System.out.println(n1 + n2);
            }
        }
    }
